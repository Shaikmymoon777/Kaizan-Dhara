...
const commitAndPush = async (repoPath, message) => {
    try {
        ...
        // Force push — temp dir is always a fresh clone with generated code,
        // so we overwrite the remote rather than merging with stale history.
        await runGit(`git push -u origin ${branch} --force`, repoPath);
